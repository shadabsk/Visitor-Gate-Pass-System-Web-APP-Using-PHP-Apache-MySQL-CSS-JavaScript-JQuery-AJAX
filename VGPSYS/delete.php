...
echo "<br>"."<br>"."<br>"."<br>";
echo "<th>InchargeId</th><th>InchargeName</th><th>IncPassword</th><th>Contact</th><th>InchargeAddress</th><th>IncAge</th><th>IncGender</th><th>IncEmailId</th><th>IncShift</th><th>Date</th><th>Delete</th>";
...
echo "<td>"; ?> <input type="button" id="<?php echo $row["Inc_ID"]; ?>" name="<?php echo $row["Inc_ID"]; ?>" value="Delete" class='uloginsubmit' onClick="delete1(this.id)"> <?php echo "</td>";
echo "<td>"; ?> 
