<html>
	...
	<div class="uloginpage">
		<form id='myForm' method='POST' action='Login_Check.php' class="loginform">
			<center>
			...
			<input type="password" name="Pass" placeholder="Password" id="secret" required class="uloginpass"></input>
			<br><br>
			...
			<p id="info-message">The details you provide dont match from the database</p>
<script>
  setTimeout(function(){
